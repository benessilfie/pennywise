...
ActiveRecord::Schema[7.0].define(version: 20_230_223_104_032) do
  ...
  create_table 'transactions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[destination_type destination_id], name: 'index_transactions_on_destination'
    t.index %w[source_type source_id], name: 'index_transactions_on_source'
